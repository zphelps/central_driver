...
class ServiceChecklist1 extends StatefulWidget {
  final String binID;
  const ServiceChecklist1({required this.binID, super.key});

  @override
  State<ServiceChecklist1> createState() => _ServiceChecklist1State();
}

class _ServiceChecklist1State extends State<ServiceChecklist1> {
  bool _loading = false;
  bool _nextEnabled = false;

  void updateNextEnabled() {
    setState(() {
      _nextEnabled = check1 && check2 && check3 && check4 && check5 && check6 && check7;
    });
  }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView(
                        children: [
                          CheckboxListTile(
                            title: const Text('Put truck in neutral'),
                            value: check1,
                            onChanged: (value) {
                            setState(() {
                              check1 = value!;
                          ...
                          CheckboxListTile(
                            title: const Text('Set parking brake'),
                            value: check2,
                            onChanged: (value) {
                            setState(() {
                              check2 = value!;
                          ...
                          CheckboxListTile(
                            title: const Text('Turn on cruise control'),
                            value: check4,
                            onChanged: (value) {
                            setState(() {
                              check4 = value!;
                          ...
                          CheckboxListTile(
                            title: const Text('Turn off truck AC'),
                            value: check5,
                            onChanged: (value) {
                            setState(() {
                              check5 = value!;
                          ...
                          CheckboxListTile(
                            title: const Text('Exit Cab & close door'),
                            value: check6,
                            onChanged: (value) {
                            setState(() {
                              check6 = value!;
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        await BinsApi().updateStep(widget.binID, 1);
                        context
