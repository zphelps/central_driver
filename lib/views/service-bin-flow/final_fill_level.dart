...
class FinalFillLevel extends StatefulWidget {
  final String serviceID;
  final Bin bin;
  const FinalFillLevel({required this.serviceID, required this.bin, super.key});

  @override
  State<FinalFillLevel> createState() => _FinalFillLevelState();
}

class _FinalFillLevelState extends State<FinalFillLevel> {
  bool _loading = false;
  ...
  void updateNextEnabled() {
    setState(() {
      _nextEnabled = widget.bin.final_fill_image != null;
    });
  }
  ...
  Widget build(BuildContext context) {
    updateNextEnabled();
    if (signedURL == null && widget.bin.final_fill_image != null) {
      _getSignedURL(widget.bin.final_fill_image!);
    }
    return Scaffold(
      appBar: AppBar(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Take a photo of the top of the container to record the final fill level.',
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 17,
                      ...
                      child: Padding(
                        ...
                        child: signedURL != null ? ClipRRect(
                          ...
                          child: Stack(
                            ...
                            child: widget.bin.final_fill_image != null ? const CircularProgressIndicator() : const Column(
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        await BinsApi().updateStep(widget.bin.id, 6);
                        context
                            .flow<ServiceBinFlowState>()
